...
let ExtendModifyLogModal = Form.create()(
    class ModifyLogModal extends Component<Prop, State>{
        ...
        render() {
            const { dispatch, okHandle, cancelHandle, visible, modifyLogModal } = this.props;
            const { Item } = Form;
...
export default connect((state: any) => ({ modifyLogModal: state.modifyLogModal }))(ExtendModifyLogModal);
