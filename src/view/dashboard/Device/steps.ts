...
import { MobileBrand } from '@src/schema/socket/MobileBrand';
 ...
 */
export function steps(type: AppDataExtractType | null, brand: MobileBrand, fetchResponseUI: number): OneStepData[] {
