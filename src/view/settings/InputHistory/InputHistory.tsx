        ...
        <div className="all-list">
            ...
            <div className="each-list">
                <List
                    ...
                    size='small'
                    locale={{ emptyText: '无数据' }}
                    header={<ListHeader delHandle={() => delHandle(HistoryKeys.HISTORY_DEVICEHOLDER)}>持有人</ListHeader>}>
                </List>
            </div>
            <div className="each-list">
                <List
                    ...
                    size='small'
                    locale={{ emptyText: '无数据' }}
                    header={<ListHeader delHandle={() => delHandle(HistoryKeys.HISTORY_DEVICENAME)}>手机名称</ListHeader>}>
                </List>
            </div>
            <div className="each-list">
                <List
                    ...
                    size='small'
                    locale={{ emptyText: '无数据' }}
                    header={<ListHeader delHandle={() => delHandle(HistoryKeys.HISTORY_DEVICENUMBER)}>手机编号</ListHeader>}>
                </List>
            </div>
            <div className="each-list">
                <List
                    ...
                    size='small'
                    locale={{ emptyText: '无数据' }}
                    header={<ListHeader delHandle={() => delHandle(HistoryKeys.HISTORY_UNITNAME)}>检验单位</ListHeader>}>
                </List>
            </div>
        </div>
    </div>;
